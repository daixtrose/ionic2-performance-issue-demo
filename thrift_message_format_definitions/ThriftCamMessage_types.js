...
ThriftCamMessage = module.exports.ThriftCamMessage = function(args) {
...
ThriftCamMessage.prototype = {};
ThriftCamMessage.prototype.read = function(input) {
...
ThriftCamMessage.prototype.write = function(output) {
  output.writeStructBegin('ThriftCamMessage');
  ...
  if (this.ValueTimeSlice !== null && this.ValueTimeSlice !== undefined) {
    output.writeFieldBegin('ValueTimeSlice', Thrift.Type.STRUCT, 4);
